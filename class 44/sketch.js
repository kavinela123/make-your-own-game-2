...
asteroid1_img = loadImage("asteroid 1.png")
asteroid2_img = createImage("asteroid2.gif")
...
function setup() {
  ...
  ground = createSprite(displayWidth,displayHeight,1000,20);
...
function asteroid1(){
ast1 = createSprite(500,500,50,50)
ast1.addImage("asteroid",asteroid1_img)
